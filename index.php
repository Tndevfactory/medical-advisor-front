...
<body>
	...
	<header class="header menu_fixed">
		...
		<ul id="top_menu">
			<li><a href="write-review.html" class="btn_top">Donner votre avis</a></li>
		...
		<nav id="menu" class="main-menu">
			<ul>
				<li><span><a href="#0">Accueil</a></span>
					
				<li><span><a href="#0">Docteurs</a></span>
					<ul>
						<li>
				...
				<li><span><a href="pricing.html">Cliniques</a></span></li>
				<li><span><a href="#0">Agences</a></span>
					<ul>
				...
				<li><span><a href="#0">Laboratoires</a></span></li>

				<li class="d-block d-sm-none"><span><a href="#0" class="btn_top">écrire un commentaire</a></span></li>
	...
	<main>
		<section class="hero_single version_1">
			<div class="wrapper">
				<div class="container">
					<h3>Chaque Avis est une expérience!</h3>
							...
							<div class="row no-gutters custom-search-input-2">
								<div class="col-lg-7">
									<div class="form-group">
										<input class="form-control" type="text" placeholder="Médecin établissement spécialité">
		...
		<div class="container margin_60">
			...
			<div id="clinicsOk" class="owl-carousel owl-theme">
				<div class="item">
					<div class="review_listing">
						...
						<ul class="clearfix">
							...
							<li><a href="reviews-page.html" class="btn_1 small">Lire avis</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="item">
					<div class="review_listing">
						...
						<ul class="clearfix">
							<li><small>Published: 26.08.2018</small></li>
							<li><a href="#0" class="btn_1 small">Lire avis</a></li>
						</ul>
					</div>
				</div>

			</div>
			<div id="clinicsNok" style="display:none" class="owl-carousel owl-theme">
				<div class="item">
					<div class="review_listing">
						<div class="clearfix">
							<figure><img src="img/avatar1.jpg" alt=""></figure>
						...
						<ul class="clearfix">
							<li><small>Published: 26.08.2018</small></li>
							<li><a href="reviews-page.html" class="btn_1 small">Lire avis nok</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="item">
					<div class="review_listing">
						...
						<ul class="clearfix">
							<li><small>Published: 26.08.2018</small></li>
							<li><a href="#0" class="btn_1 small">Lire avis nok</a></li>
						</ul>
					</div>
				</div>
			...
			<div class="clearfix">
					...
					<button id="btnClinicOk" class="btn btn-outline-success float-left">
					<i class="icon-thumbs-up"></i>Top 5 Cliniques</button>
				
					<button id="btnClinicNok" class="btn btn-outline-danger float-right">
					<i class=" icon-thumbs-down"></i>Flop 5 Cliniques</button>
			</div>
		...
		<div class="container margin_60">
			...
			<div id="agences" class="owl-carousel owl-theme">
				<div class="item">
					<div class="review_listing">
						<div class="clearfix">
							<figure><img src="img/avatar1.jpg" alt=""></figure>
			...
			<div class="clearfix">
				<button class="btn btn-outline-success float-left">
					<i class="icon-thumbs-up"></i>Top 5 Agences</button>
				<button class="btn btn-outline-danger float-right">
					<i class=" icon-thumbs-down"></i>Flop 5 Agences</button>
			</div>
		...
		<div class="call_section_3">
			<div class="wrapper">
			<h1 class="text-center text-white mt-0 mb-5">Votre avis</h1>
				<div class="container clearfix">
					<div class="row text-center">
						<div class="col-lg-4 col-md-12 ">
							<p>Sur votre séjour dans une clinique</p>
							<i style="font-size:55px;color:white" class="icon-smile"></i><br><br>
							<p><a class="btn btn-primary" href="pricing.html" data-wow-delay="0.5s">Donner un avis</a></p>
						</div>
						<div class="col-lg-4 col-md-12 ">
							<p>Sur votre séjour dans une agence</p>
							<i style="font-size:55px;color:white" class="icon-home-1"></i><br><br>
							<p><a class="btn btn-primary" href="pricing.html" data-wow-delay="0.5s">Donner un avis</a></p>
						</div>
						<div class="col-lg-4 col-md-12 ">
							<p>Sur votre parcours de soins</p>
							<i style="font-size:55px;color:white" class=" icon-doc-text-2"></i><br><br>
							<p><a class="btn btn-primary" href="pricing.html" data-wow-delay="0.5s">Donner un avis</a></p>
						</div>
					</div>	
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<div class="collapse show" id="collapse_ft_2">
						<ul class="links">
							<li><a href="#0">Docteurs</a></li>
							<li><a href="#0">Cliniques</a></li>
							<li><a href="#0">Agences</a></li>
							<li><a href="#0">Laboratoires</a></li>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<div class="collapse show" id="collapse_ft_3">
						<ul class="contacts">
							<li><i class="ti-home"></i>97845 Baker st. 567<br>France</li>
			...
			<div class="row">
						...
						<li>
							<div class="styled-select" id="lang-selector">
								<select>
									...
									<option value="Russian">Anglais</option>
									<option value="Spanish">Arabe</option>
								</select>
							</div>
						</li>
					</ul>
				...
				<div class="col-lg-6">
					<ul id="additional_links">
						...
						<li><span>© 2020 Medical Advisor</span></li>
					</ul>
				</div>
			</div>
		</div>
